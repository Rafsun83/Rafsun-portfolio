    ...
    return (
        <div className='portfolio  container-fluid '>
            <div className="title text-center text-muted mt-3 pt-5">
                <span style={{ fontSize: "30px" }} >Portfolio And Some Cool Projects</span>
            </div>
            <div className="me-auto ms-auto mt-5">
                <Tabs value={tabValue} indicatorColor='white' className='custom_tab' onChange={
                    (e, i) => setTabValue(i)
                }>
                    <Tab label='All' value='All' style={{ color: "white" }} className={tabValue === 'All' ? 'customTabs_item active' : 'customTabs_item'} />
                                                    ...
                                                    <div className="frontside">
                                                        <div className="card custom_card">
                                                            <div className="card-body text-center">
                                                                <p><img style={{ height: "200px" }} className=" img-fluid" src={project.image} alt="card image" /></p>
