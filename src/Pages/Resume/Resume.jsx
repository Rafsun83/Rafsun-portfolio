...
const Resume = () => {
    ...
    var hindi = 65
    return (
        <div className="resume p-4  mb-4  mt-3">
            <div className="container-fluid">
                <div className="heading">
                    <span className='text-muted' style={{ fontSize: "30px" }} >Education & Skill</span>
                    <hr />
                </div>
                <div className="row d-flex align-items-center justify-content-center">
                    ...
                    <motion.div
                        ...
                        <div className="progressbar pb-2">
                            <div className="label">
                                <span style={{ color: "gray" }}>React</span>
                        ...
                        <div className="progressbar pb-2">
                            <div className="label">
                                <span style={{ color: "gray" }}>React-Native</span>
                        ...
                        <div className="progressbar pb-2">
                            <div className="label">
                                <span style={{ color: "gray" }}>Expres.js and mongodb</span>
                        ...
                        <div className="l-t mt-3">
                            ...
                            <div className="row mt-3">
                                ...
                                <div className="col-md-4 c col-sm-4 text-center">
                                    <span className='text-center' style={{ color: "gray" }} >Bangla</span>
                                ...
                                <div className="col-md-4 c col-sm-4 text-center">
                                    <span className='text-center' style={{ color: "gray" }}>English</span>
                                ...
                                <div className="col-md-4 c col-sm-4 text-center">
                                    <span className='text-center' style={{ color: "gray" }}>hindi</span>
